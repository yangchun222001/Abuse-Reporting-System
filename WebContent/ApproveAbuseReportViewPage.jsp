        		...
        		<tbody class="searchable">
        			...
        			for (AbuseReport abuseReport:listOfSupervisorReport){ %><tr>
        				...
        				<td data-title="Actions">
							<div class="progress">
 							<div class="progress-bar" role="progressbar" aria-valuenow="2" aria-valuemin="0" aria-valuemax="8" style="width:25%">2/8</div>
							</div>
        				</td>
            ...
            <table class="col-md-12 table-bordered table-striped table-condensed cf" style="padding:0px; width: 100%;">
        		...
        		<tbody>
        			...
        			for (AbuseReport abuseReport:listOfApproveReport){ %><tr>
        				...
        				<a class="btn btn-primary appeal" data-toggle="modal" data-id="<%=abuseReport.getId()%>" >Upload</a> <%}else{ %>
            			...
            			<a class="btn btn-primary appeal" data-toggle="modal" data-id="<%=abuseReport.getId()%>" >Change</a>
            			<a id="button" class="btn btn-success btn-xs" href="<%= response.encodeUrl(request.getContextPath() + "/Controller?action=approveletter&reportId="+abuseReport.getId())+"&sta=6" %>"><i class="glyphicon glyphicon-ok"></i>&nbsp;Approve</a>						
            			<%} %>
