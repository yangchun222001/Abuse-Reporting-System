...
<div class="container">
    <div class="row">
      ...
      <div class="row">
      	  <form  name="frmForm" class="form-horizontal" method="post" action="<%= response.encodeUrl(request.getContextPath() + "/Controller?action=docreatedisability") %>">
			<fieldset>
			<legend>New Disability   <font color="red"> <c:out value="${message}" /></font></legend> 
      					<!-- Text input-->
				<div class="form-group">
				  <label class="col-md-4 control-label" for="disabilityname">Disability Name</label>  
				  <div class="col-md-4">
				  <input id="disabilityname" name="disabilityname" type="text" placeholder="disability name" class="form-control input-md" required>
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
				    <select id="disabilitytype" name="disabilitytype" class="form-control">
				      <%for(DisabilityType disabilityType: listOfDisabilityType) {%><option value="<%=disabilityType.getId()%>"><%=disabilityType.getType()%></option><%} %>
				    </select>
				  </div>
				</div>
