            ...
            <div class="panel panel-info" >
                    ...
                    <div style="padding-top:10px" class="panel-body" >
                        ...
                        <form id="loginform" class="form-horizontal" role="form" method="post" action="<%= response.encodeUrl(request.getContextPath() + "/Controller?action=dologin") %>">
                            <div class="input-group panel-title" style="margin-bottom: 10px">Sign in<p class="help-block"><font size="2" color="green"><c:out value="${message}" /></font> </p></div>
                            
                            <div style="margin-bottom: 25px" class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                        <input id="login-username" type="text" class="form-control" name="email" value="" placeholder="username(email)">                                        
                                    </div>   
...
<!--         <div id="signupbox" style="display:none; margin-top:100px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
        ...
        <div id="getpasswordbox" style="display:none; margin-top:100px" class="mainbox col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body" >
                            <form id="signupform" class="form-horizontal" role="form" method="post" action="<%= response.encodeUrl(request.getContextPath() + "/Controller?action=dosendemail") %>">
                                <div id="signupalert" style="display:none" class="alert alert-danger">
                                    <p>Error:</p>
                                    <span></span>
                                </div>
                                ...
                                <div style="margin-top:10px" class="form-group">
                                    <!-- Button -->                                        
                                    <div class="col-md-offset-3 col-md-9">
                                    	<input id="btn-send" type = "submit" value= "Send" class="btn btn-info">
