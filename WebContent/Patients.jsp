            ...
            <table class="col-md-12 table-bordered table-striped table-condensed cf " style="padding:0px; width: 100%;">
        		...
        		<tbody class="searchable">
        			...
        			for(Patient patient: listOfPatient) {i++;%><tr >
						...
						<a id="button" class="btn btn-success btn-xs" href="<%= response.encodeUrl(request.getContextPath() + "/Controller?action=updatepatient&patientlognumber="+patient.getLogNumber()) %>"><i class="glyphicon glyphicon-ok"></i>&nbsp;Update</a>
						</div>
						</td>
        			</tr><%} %>
