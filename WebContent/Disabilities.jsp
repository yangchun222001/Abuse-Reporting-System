...
<div class="container">
    <div class="row">
        ...
        <div class="col-xs-6" style="padding:0px">
            <h3 class="text-right">
                <a id="btn-create" type="button" class="btn btn-primary" href="<%= response.encodeUrl(request.getContextPath() + "/Controller?action=newdisability") %>"><i class="glyphicon glyphicon-plus"></i>&nbsp;New Disability</a>
            </h3> 
        </div>
      </div>
      <div class="row">
            ...
            <table class="col-md-12 table-bordered table-striped table-condensed cf " style="padding:0px; width: 100%;">
        		...
        		<tbody class="searchable">
        			...
        			for(Disability disability: listOfDisability) {i++;%><tr >
						...
						<a id="button" class="btn btn-success btn-xs" href="<%= response.encodeUrl(request.getContextPath() + "/Controller?action=updatedisability&disabilityId="+disability.getId()) %>"><i class="glyphicon glyphicon-ok"></i>&nbsp;Update</a>
						</div>
						</td>
        			</tr><%} %>
...
<div class="modal fade" id="myModal<%=j %>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <form method="post" action="<%= response.encodeUrl(request.getContextPath() + "/Controller?action=dodeletedisability") %>">
