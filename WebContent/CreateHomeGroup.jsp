...
<div class="container">
    <div class="row">
      ...
      <div class="row">
      	  <form  name="frmForm" class="form-horizontal" method="post" action="<%= response.encodeUrl(request.getContextPath() + "/Controller?action=docreatehomegroup") %>">
			<fieldset>
			<legend>New Home Group   <font color="red"> <c:out value="${message}" /></font></legend> 
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
				  <input id="homegroupname" name="homegroupname" type="text" placeholder="home group name" class="form-control input-md" required>
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
				    <select id="healthcareorg" name="healthcareorg" class="form-control">
				      <%for(HealthCareOrg healthCareOrg: listOfHealthCare) {%><option value="<%=healthCareOrg.getId()%>"><%=healthCareOrg.getMasterDataName()%></option><%} %>
				    </select>
				  </div>
				</div>
