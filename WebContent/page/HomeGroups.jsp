        ...
        <div class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav">
            ...
            <ul class="dropdown-menu">
                ...
                <li class="active"><a href="HomeGroups.jsp">Home Groups</a></li>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-xs-6" style="padding:0px">
            <h3 class="text-right">
                <a id="btn-create" type="button" class="btn btn-primary" href="#"><i class="glyphicon glyphicon-plus"></i>&nbsp;New Home Group</a>
            </h3> 
        </div>
      </div>
    </div>
