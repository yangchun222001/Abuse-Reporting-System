		...
		<div class="row">
			...
			<legend>General Information</legend>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4"> 
				    <label class="radio-inline" for="radios-0">
				      <input type="radio" name="mandated" id="radios-0" value="Yes">
				      Yes
				    </label> 
				    <label class="radio-inline" for="radios-1">
				      <input type="radio" name="mandated" id="radios-1" value="No" required>
				      No
				    </label>
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <label class="col-md-4 control-label" for="addallegedvictim">Alleged Victim (Patient) <input type=radio value="Patient" checked  onclick="lockIt(_F)"   id=radio1 name=radio1></label>
				  
				  <div class="col-md-4">
				    <select id="selectbasic" name="allegedVictimPatient" class="form-control" onfocus="if (isDis())blur();" >
				      <%for (Patient patient:listOfAllPatient){ %><option value="<%= patient.getId()%>"><%=patient.getPatientName() %> <%=patient.getPatientMidname() %> <%=patient.getPatientLastName() %></option>
				      <%} %>
				    </select>
				  </div>
				</div>
				...
				<div class="form-group">
				  <label class="col-md-4 control-label" for="addallegedvictim">Alleged Victim (Staff) <input type=radio value="Staff"    onclick="lockIt(_T)" id=radio1 name=radio1></label>
				  <div class="col-md-4">
				    <select id="selectbasic" name="allegedVictimStaff" class="form-control" onfocus="if (isDis())blur();" disabled>
				      <%for (User victimStaff:listStaffMembers){ %><option value="<%= victimStaff.getId()%>"><%=victimStaff.getUserName() %> <%=victimStaff.getUserLastName() %></option>
				      <%} %>
				    </select>
				  </div>
				</div>
				...
				<div class="form-group">
				  <label class="col-md-4 control-label" for="addallegedabuser">Alleged Abuser (Patient) <input type=radio value="Patient"    onclick="lockIt2(_T)" id=radio2 name=radio2></label>
				  <div class="col-md-4">
				    <select id="selectbasic" name="allegedAbuserPatient" class="form-control" onfocus="if (isDis2())blur();"disabled>
				      <%for (Patient abuserPatient:listOfAllPatient){ %><option value="<%=abuserPatient.getId() %>"><%=abuserPatient.getPatientName() %> <%=abuserPatient.getPatientMidname() %> <%=abuserPatient.getPatientLastName() %></option>
				      <%} %>
				    </select>
				</div>
				</div>
				...
				<div class="form-group">
				  <label class="col-md-4 control-label" for="addallegedabuser">Alleged Abuser (Staff) <input type=radio value="Staff"  checked  onclick="lockIt2(_F)" id=radio2 name=radio2></label>
				  <div class="col-md-4">
				    <select id="selectbasic" name="allegedAbuserStaff" class="form-control" onfocus="if (isDis2())blur();">
				      <%for (User user:listStaffMembers){ %><option value="<%=user.getId() %>"><%=user.getUserName() %> <%=user.getUserLastName() %></option>
				      <%} %>
				    </select>
				</div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4"> 
				    <label class="radio-inline" for="awareofreport-0">
				      <input type="radio" name="awareofreport" id="awareofreport-0" value="Yes" required>
				      Yes
				    </label> 
