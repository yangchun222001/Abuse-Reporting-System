      ...
      <div class="row">
			...
			<legend>New Patient   <font color="red"> <c:out value="${message}" /></font></legend> 
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
				  <input id="patientname" name="patientname" type="text" placeholder="patient name" class="form-control input-md" required>
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
				  <input id="patientmidname" name="patientmidname" type="text" placeholder="patient mid name" class="form-control input-md" required>
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
				  <input id="patientlastname" name="patientlastname" type="text" placeholder="patient last name" class="form-control input-md" required>
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4"> 
				    <label class="radio-inline" for="radios0">
				      <input type="radio" name="sex" id="radios0" value="M" required>
				      Male
				    </label> 
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
				  <input id="iq" name="iq" type="text" placeholder="IQ" class="form-control input-md" required>
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
				  <input id="birthdate" name="birthdate" type="text" placeholder="birthdate" class="form-control input-md" required>
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
				  <input id="telephone" name="telephone" type="text" placeholder="telephone" class="form-control input-md" required>
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
				    <select id="grouphome" name="grouphome" class="form-control">
				      <%for(GroupHome groupHome: listOfGroupHome) {%><option value="<%=groupHome.getId()%>"><%=groupHome.getMasterDataName() %></option><%} %>
				    </select>
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
				    <select id="currentlyservedby" name="currentlyservedby" class="form-control">
				      <%for(CurrentlyServedBy currentlyServedBy: listOfCurrentlyServed) {%><option value="<%=currentlyServedBy.getId()%>"><%=currentlyServedBy.getMasterDataName()%></option><%} %>
				    </select>
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
				    <select id="ethnicity" name="ethnicity" class="form-control">
				      <%for(Ethnicity ethnicity: listOfEthnicity) {%><option value="<%=ethnicity.getId()%>"><%=ethnicity.getMasterDataName() %></option><%} %>
				    </select>
				  </div>
				</div>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
				    <select id="clientguardian" name="clientguardian" class="form-control">
				      <%for(User guardian: listOfClientGuardian) {%><option value="<%=guardian.getId()%>"><%=guardian.getUserName()%> <%=guardian.getUserLastName() %></option><%} %>
				    </select>
				  </div>
				</div>
