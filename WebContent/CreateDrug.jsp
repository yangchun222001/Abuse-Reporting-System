...
<div class="container">
    <div class="row">
      ...
      <div class="row">
      	  <form  name="frmForm" class="form-horizontal" method="post" action="<%= response.encodeUrl(request.getContextPath() + "/Controller?action=docreatedrug") %>">
			<fieldset>
			<legend>New Drug   <font color="red"> <c:out value="${message}" /></font></legend> 
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">
				  <input id="drugname" name="drugname" type="text" placeholder="drugname" class="form-control input-md" required>
				  </div>
				</div>
